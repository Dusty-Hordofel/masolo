...
export function ImageUploaderv12({ onImageUploaded, onImageDeleted, onSelectionChange }: ImageUploaderProps) {
        ...
        {!file ? (
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-3 p-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mb-1">Glissez-déposez ou cliquez</p>
          ...
          <div className="relative aspect-square">
            ...
            <img
              ...
              alt="Preview"
              className={cn("w-full h-full object-cover", isComplete ? "cursor-pointer" : "")}
