...
export function MultiImageUploader5() {
  ...
  console.log("🚀 ~ MultiImageUploader5 ~ selectedProducts:", selectedProducts);
  ...
  // Ferme tous les filtres quand viewMode change
  // useEffect(() => {
  //   setOpenFilter(null);
  // }, [viewMode]);

  // Optionnel: Ferme les filtres quand on clique ailleurs
  // useEffect(() => {
  ...
  //   setOpenFilter(null); // Ferme tous les filtres
  // };
        ...
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden flex flex-col p-0">
          <DialogHeader>
            ...
            <div className="space-y-4  px-5 py-3">
              ...
              {/* Filters and Sort */}
              <div
                className="flex  overflow-x-auto gap-4 md:overflow-x-visible
                 "
              >
                {/* // Au lieu de 5 composants séparés */}
                {/* <FilterControls
                  // Sort
                  sortBy={sortBy}
                  setSortBy={setSortBy}
...
import MediaLibraryItem from "./media-library-item";
// import { Button } from "@/components/ui/button";
// import { Grid3X3, List, ChevronDown, Check } from "lucide-react";
